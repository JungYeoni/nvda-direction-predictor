...
같은 feature와 split에서 타깃만 바꾼 v6 후보 실험에서는 `NVDA 수익률 - QQQ 수익률 > 0.2%p` 타깃이 가장 유망했다.

| 타깃 | 모델 | Accuracy | Balanced Acc | ROC-AUC | MCC |
|------|------|----------|--------------|---------|-----|
| 기존 방향: NVDA return > 0 | LR | 53.33% | 0.528 | 0.558 | 0.058 |
| 절대 상승: NVDA return > 0.2% | LR | 52.89% | 0.527 | 0.573 | 0.055 |
| QQQ 초과: NVDA - QQQ > 0 | LR | 56.44% | 0.564 | 0.592 | 0.128 |
